...
exports.congratulateStudent = () => {
  ...
  exports.printMessage(`🧹  nettoyer ton code, pour ne garder que les instructions et commentaires nécessaires à son bon fonctionnement;`);
  exports.printMessage(`📝  ajouter des commentaires aux parties du code les moins évidentes, pour te souvenir à quoi elles servent;`);
  exports.printMessage(`📒  puis à garder une copie du code dans tes notes de cours, de manière à les retrouver rapidement quand tu en auras besoin.`);
};
